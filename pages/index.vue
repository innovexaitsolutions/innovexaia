  ...
  <div>
      ...
      <div class="container mx-auto px-4 flex items-center">
        <div class="w-full text-start">
          <div class="flex flex-col align-center">
            <h2 class="text-4xl md:text-6xl font-bold mb-8 t text-center">
            ...
            <p class="text-lg md:text-2xl mb-8 text-center">
              ...
              businesses, <br />helping them achieve their business goals and enhance
              competitiveness.
            </p>
    ...
    <section class="py-8 bg-gray-50">
      ...
      <div class="container mx-auto px-4 flex items-center gap-8 mb-20">
        ...
        <div class="w-1/2">
          <h2 class="text-4xl font-bold mb-6 text-[#7b97ca]">
          ...
          <p class="text-lg text-justify leading-6">
            ...
            understand the latest trends in the US stock market, seize investment
            opportunities, and achieve your financial goals.
          </p>
        </div>
      </div>
    </section>
